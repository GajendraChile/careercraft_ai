from profile_searcher_agent import create_profile_searcher_agent
...
skill = AgentSkill(
        id='profile_analyser',
        name='profile analyser Agent',
        description='Agent that searches for the most suitable profiles according to the job description',
        tags=['Profile', 'Profile Searcher']
    )
...
with streamable_http_mcp_client:
    ...
    agent = create_profile_searcher_agent(tools)
