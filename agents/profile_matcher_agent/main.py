from profile_matcher_agent import create_profile_matcher_agent
...
skill = AgentSkill(
        id='profile_matcher',
        name='profile matcher Agent',
        description='Agent that matches the most suitable profiles according to the job description',
        tags=['Profile', 'Profile Matcher']
    )
...
with streamable_http_mcp_client:
    ...
    agent = create_profile_matcher_agent(tools)
    ...
    uvicorn.run(fastapi_app, host="0.0.0.0", port=9001)